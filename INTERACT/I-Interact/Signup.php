            ...
            if(id==""){
                ...
                if(!(id.charAt(0)=='R'||id.charAt(0)=='r')){
                    ...
                    return false;
                        ...
                        if((id.charAt(1)=='C'&&id.charAt(2)=='S')||(id.charAt(1)=='C'&&id.charAt(2)=='E')||(id.charAt(1)=='C'&&id.charAt(2)=='H')||(id.charAt(1)=='M'&&id.charAt(2)=='M')||(id.charAt(1)=='M'&&id.charAt(2)=='E')||(id.charAt(1)=='E'&&id.charAt(2)=='C')||(id.charAt(1)=='E'&&id.charAt(2)=='E')){
                ...
                if(!(id.charAt(0)=='B'||id.charAt(0)=='b')){
                    ...
                    return false;
                       ...
                       for (var i = 1; i < id.length; i++) {
                            if(isNaN(id.charAt(i))||id.charAt(1)>1||(id.charAt(1)>0&&id.charAt(2)>6)||(id.charAt(1)==0&&id.charAt(2)<8)){
                                    document.getElementById('id_error').innerHTML=" * Your id number is not valid";
                                    return false;
                            }       
                        }
