...
//echo $content;
//For question count
$q="SELECT * FROM Question WHERE id='$student_id'";
...
//echo $count;
//echo $_POST['count'];
$query="INSERT INTO Question (id,question,date,count) VALUES('$student_id','$content',NOW(),$count)";
    ...
    <script type="text/javascript">
    	...
    	function postAns(id,i,qsn){
    		...
    		if(document.getElementById('question'+qsn).value!=""){
    			...
    			var student_id=id;
    			window.location.href = "saveAns.php?question_id=" + student_id + "&ans=" + ans+"&qno="+qsn;
							...
							<?php
							    		...
							    		while($row=mysqli_fetch_array($result)){
							    				...
							    				if($qns[0]=='R'||$qns[0]=='r'){
							    					$q1="SELECT * FROM FacultyDetails WHERE faculty_id='$row[1]'";
							  						...
							  						echo "<tr><td>$i. <img src='../Faculty/$row4[8]' width='30px' height='30px'/>&nbsp;&nbsp;&nbsp;<b>$row4[2]</b> asks $row[2]<br><br>";
							    				...
							    				else
							    					{
							  						...
							  						$rr1=mysqli_query($link,$q1);
							  						$row4=mysqli_fetch_array($rr1);
							  						echo "<tr><td>$i. <img src='$row4[10]' width='30px' height='30px'/>&nbsp;&nbsp;&nbsp;<b>$row4[2]</b> asks $row[2]<br><br>";
							    					}	
							  			...
							  			while($r=mysqli_fetch_array($result2)){
							  				...
							  				//else{
							  					...
							  					if($c[0]=='R'||$c[0]=='r'){
							  						...
							  						$row4=mysqli_fetch_array($rr1);
							  						//echo $row4[8];
							  						echo "<img src='../Faculty/$row4[8]' width='30px' height='30px'/>&nbsp;&nbsp;&nbsp;<b>$row4[2]</b>'s answer is $r[2]<br><br>";
							  						...
							  						$row4=mysqli_fetch_array($rr1);
							  						//echo $row4[8];
							  						echo "<img src='$row4[10]' width='30px' height='30px'/>&nbsp;&nbsp;&nbsp;<b>$row4[2]</b>'s answer is $r[2]<br><br>";
							  					}
							  			//	}
							 ...
							 <?php echo " 
							  ...
							  <div id='answer_this_question$row[0]' class='collapse'><br>
							    ...
							    <textarea id='question$row[0]' class='form-control' rows='4' cols='50' name='question$row[0]' placeholder='Text your answer.....'></textarea>
