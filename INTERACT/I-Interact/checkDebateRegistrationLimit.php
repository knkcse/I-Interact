...
$query="SELECT * FROM DebateRegister WHERE id='$student_id'";
...
if($count==1){
	 ...
	 date_default_timezone_set("Asia/Kolkata");
		...
		$now=$diff->format("%R%a days");
		 echo "
						<br><br>
							  <button type='button' class='btn btn-info' data-toggle='collapse' data-target='#answer_this_question$row[0]'>View List</button>
