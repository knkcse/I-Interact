...
$chat=$_POST['chat'];
$query="INSERT INTO Debate(id,post,date) VALUES ('$student_id','$chat',NOW())";
...
<div class="row "><br>
  ...
  <center><h3>Debate Topic is Social Neworks</h3></center>
  <br><br>
        ...
        while($row=mysqli_fetch_array($result)){
            ...
            if($row[1]==$student_id){
              ...
              $row5=mysqli_fetch_array($rr1);
                ...
                echo "<tr><td class='left'>$row[3] &nbsp;<img src='$row5[10]' width='30px' height='30px'/><br><sub>$row[4]</sub></td></tr>";
            }
            else{
              $cc=$row[1];
              if($cc[0]=='B'||$cc[0]=='b'){
              ...
              $row5=mysqli_fetch_array($rr1);
                ...
                echo "<tr><td><img src='$row5[10]' width='30px' height='30px'/>&nbsp;<b>$row5[2]</b><br>$row[3] &nbsp;<br><sub>$row[4]</sub></td></tr>";
              }
              ...
              $row5=mysqli_fetch_array($rr1);
                ...
                echo "<tr><td><img src='../Faculty/$row5[8]' width='30px' height='30px'/>&nbsp;<b>$row5[2]</b><br>$row[3] &nbsp;<br><sub>$row[4]</sub></td></tr>";
              }
            }
